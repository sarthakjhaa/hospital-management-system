...
async function GET(req, { params }) {
    try {
        ...
        if (session.role === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f40$prisma$2f$client$29$__["Role"].PATIENT && session.patientProfileId !== id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Access denied: Cannot access another patient private record'
            }, {
                status: 403
            });
        }
        const patient = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patientProfile.findUnique({
            where: {
                id
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1q2655z._.js.map