...
async function GET(req) {
    try {
        ...
        const [notifications, unreadCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.findMany({
                where: {
                    userId: session.id
                },
                orderBy: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.count({
                where: {
                    userId: session.id,
                    isRead: false
                }
...
async function PATCH(req) {
    try {
        ...
        if (notificationId) {
            ...
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.findUnique({
                where: {
                    id: notificationId
                }
            });
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.update({
                where: {
                    id: notificationId
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02064ej._.js.map