...
async function GET(req) {
    try {
        ...
        const [patients, doctors, appointments, medicines, bills] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patientProfile.findMany({
                where: {
                    OR: [
                        {
                            patientIdCode: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].doctorProfile.findMany({
                where: {
                    OR: [
                        {
                            specialty: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment.findMany({
                where: {
                    OR: [
                        {
                            appointmentNo: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].medicine.findMany({
                where: {
                    OR: [
                        {
                            name: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bill.findMany({
                where: {
                    OR: [
                        {
                            billNo: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0nn1yzz._.js.map